...
- [插件 / 扩展 SDK 最小骨架](architecture/plugin-sdk.md)
...
- [**v0.1.0-rc.1 — 核心链路基线（当前）**](releases/v0.1.0-rc.1.md)
...
- [**交接说明（2026-09-11 晚）：核心链路基线 —— 工具/动作拆除 + 音频走媒体元素 + 三个真缺陷**](plans/HANDOFF-2026-09-11-core-chain-baseline.md)
  ——**接手先读本文**：一分钟上手、门禁数字、LLM 工具/动作系统为何整体拆除、
  音频为何从 Web Audio 改走 `<audio>`+WAV、三个真缺陷的根因、故意没做的事、
  **七个必须知道的坑**（含真机点火操作指南与「音频是广播的 → 多页面 = 回音」）
